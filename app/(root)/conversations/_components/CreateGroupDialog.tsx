...
//                 {friends?.filter(
//                   ((friend) => members.includes(friend._id)).map((friend) => {
//                     return (
//                       <div
//                         key={friend._id}
...
//                             </AvatarFallback>
//                           </Avatar>
//                           <X className="text-muted-foreground w-4 h-4 absolute bottom-8 left-7bg-muted rounded-fullcursor-pointer" onClick={()=> form.setValue("members", members.filter(id => id!== friend._id))}/>
//                         </div>
